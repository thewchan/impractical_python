...
class Game(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.photo_lbl = tk.Label(
            self.parent, image=img, text='', borderwidth=0,
            )
        ...
        a = tk.Radiobutton(
            self.parent, text='A', variable=self.door_choice, value='a',
            command=self.win_reveal,
            )
        b = tk.Radiobutton(
            self.parent, text='B', variable=self.door_choice, value='b',
            command=self.win_reveal,
            )
        c = tk.Radiobutton(
            self.parent, text='C', variable=self.door_choice, value='c',
            command=self.win_reveal,
            )
        ...
        self.yes = tk.Radiobutton(
            self.parent, state='disabled', text='Y', variable=self.change_door,
            value='y', command=self.show_final,
            )
        self.no = tk.Radiobutton(
            self.parent, state='disabled', text='N', variable=self.change_door,
        ...
        self.unchanged_wins_txt = tk.Text(
            self.parent, width=20, height=1, wrap=tk.WORD, bg=defaultbg,
            fg='black', borderwidth=0,
            )
        self.changed_wins_text = tk.Text(
            self.parent, width=20, height=1, wrap=tk.WORD, bg=defaultbg,
            fg='black', borderwidth=0,
            )
        ...
        self.changed_wins_text.grid(row=2, column=5, columnspan=5)
    ...
    def show_final(self):
        ...
        self.changed_wins_text.insert(
            1.0, f'Changed wins = {self.pick_change_wins:d}',
            )
        ...
        # close doors 2 second after opening
        self.img_file = 'all_closed.png'
        self.parent.after(2000, self.update_image)
